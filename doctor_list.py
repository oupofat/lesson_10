...
def episode_list (target_doctor, doctor_who):
    list =[]
    for record in doctor_who:
        if record.doctor == target_doctor:
            list.append(record.episode)
    return list
target_doctor = input("Which is your favorite Doctor?")
print(episode_list(target_doctor, doctor_who))
